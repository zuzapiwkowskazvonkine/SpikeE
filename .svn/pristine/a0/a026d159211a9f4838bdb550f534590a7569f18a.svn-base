function varargout = Order_Statistic_Filter(varargin)
% ORDER_STATISTIC_FILTER This App uses MATLAB's ordfilt2 function to
...
% Edit the above text to modify the response to help Order_Statistic_Filter

% Last Modified by GUIDE v2.5 25-May-2012 17:39:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Order_Statistic_Filter_OpeningFcn, ...
                   'gui_OutputFcn',  @Order_Statistic_Filter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Order_Statistic_Filter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Order_Statistic_Filter (see VARARGIN)

% Choose default command line output for Order_Statistic_Filter
...
function varargout = Order_Statistic_Filter_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    for i=1:length(tracesToProcess)
        ...
        newTrace=ordfilt2(thisTrace, pointRank, ones(numPoints,1));
        if keepTraces
            saveInd=numTraces+i;
        ...
        SpikeTraceData(saveInd).Label.ListText=['ordfilt ', SpikeTraceData(traceInd).Label.ListText];
    end
