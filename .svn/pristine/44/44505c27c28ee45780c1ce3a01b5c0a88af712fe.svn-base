function varargout = Find_Falling_Edge_Binary(varargin)
% FIND_FALLING_EDGE_BINARY This App takes in a binary trace and sets the
...
% Edit the above text to modify the response to help Find_Falling_Edge_Binary

% Last Modified by GUIDE v2.5 01-Jun-2012 14:08:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Find_Falling_Edge_Binary_OpeningFcn, ...
                   'gui_OutputFcn',  @Find_Falling_Edge_Binary_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Find_Falling_Edge_Binary_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Find_Falling_Edge_Binary (see VARARGIN)

% Choose default command line output for Find_Falling_Edge_Binary
...
if (length(varargin)>1)
    ...
    set(handles.Threshold, 'String', Settings.NumPointsString);
...
Settings.NumPointsString=get(handles.Threshold, 'String');
Settings.PointRankString=get(handles.PointRank, 'String');


% --- Outputs from this function are returned to the command line.
function varargout = Find_Falling_Edge_Binary_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    for i=1:length(tracesToProcess)
        ...
        SpikeTraceData(saveInd).Label.ListText=['ends ', SpikeTraceData(traceInd).Label.ListText];
    end
