function varargout = Binarize_Trace(varargin)
% BINARIZE_TRACE This App takes in a trace and sets it to 1 when it is
...
% Edit the above text to modify the response to help Binarize_Trace

% Last Modified by GUIDE v2.5 23-Jul-2012 13:19:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Binarize_Trace_OpeningFcn, ...
                   'gui_OutputFcn',  @Binarize_Trace_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Binarize_Trace_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Binarize_Trace (see VARARGIN)

% Choose default command line output for Binarize_Trace
...
if (length(varargin)>1)
    ...
    set(handles.ThresholdTop, 'String', Settings.ThresholdTopString);
    set(handles.ThresholdBelow, 'String', Settings.ThresholdBelowString);
...
Settings.ThresholdTopString=get(handles.ThresholdTop, 'String');
Settings.UseAllTracesValue=get(handles.UseAllTraces, 'Value');
Settings.ThresholdBelowString=get(handles.ThresholdBelow, 'String');
Settings.UseMeanValue=get(handles.UseMean, 'Value');
Settings.NumberStdsString=get(handles.NumberStds, 'String');


% --- Outputs from this function are returned to the command line.
function varargout = Binarize_Trace_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    useMean=get(handles.UseMean, 'Value');
    if ~useMean
        upperThresh=str2double(get(handles.ThresholdTop, 'String'));
    else
        numStds=str2double(get(handles.NumberStds, 'String'));
    end
    lowerThresh=str2double(get(handles.ThresholdBelow, 'String'));
    ...
    for i=1:length(tracesToProcess)
        ...
        if useMean
            upperThresh=mean(thisTrace)+numStds*std(thisTrace);
        end
        newTrace=and(thisTrace>lowerThresh, thisTrace<upperThresh);
        if keepTraces
            saveInd=numTraces+i;
        ...
        SpikeTraceData(saveInd).Label.ListText=['binary ', num2str(lowerThresh), '-', num2str(upperThresh), ' ', SpikeTraceData(traceInd).Label.ListText];
    end
...
function ThresholdTop_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function ThresholdTop_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ThresholdTop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in UseMean.
function UseMean_Callback(hObject, eventdata, handles)
% hObject    handle to UseMean (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of UseMean
if (get(handles.UseMean,'Value')==1)
    set(handles.ThresholdTop,'Enable','off');
else
    set(handles.ThresholdTop,'Enable','on');
end



function NumberStds_Callback(hObject, eventdata, handles)
% hObject    handle to NumberStds (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of NumberStds as text
%        str2double(get(hObject,'String')) returns contents of NumberStds as a double


% --- Executes during object creation, after setting all properties.
function NumberStds_CreateFcn(hObject, eventdata, handles)
% hObject    handle to NumberStds (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ThresholdBelow_Callback(hObject, eventdata, handles)
% hObject    handle to ThresholdTop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function ThresholdBelow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ThresholdTop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
