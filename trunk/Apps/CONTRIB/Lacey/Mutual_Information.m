function varargout = Mutual_Information(varargin)
% MUTUAL_INFORMATION This App aligns one or more traces to points given in the
...
% Edit the above text to modify the response to help Mutual_Information

% Last Modified by GUIDE v2.5 14-Jun-2012 23:37:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Mutual_Information_OpeningFcn, ...
                   'gui_OutputFcn',  @Mutual_Information_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Mutual_Information_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Mutual_Information (see VARARGIN)

% Choose default command line output for Mutual_Information
...
function varargout = Mutual_Information_OutputFcn(hObject, eventdata, handles) 
