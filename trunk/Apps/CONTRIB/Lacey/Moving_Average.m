...
% MOVING_AVERAGE This App performs a moving average on a trace or set of traces, with the
% length of the average set in the interface. The resulting trace will be
