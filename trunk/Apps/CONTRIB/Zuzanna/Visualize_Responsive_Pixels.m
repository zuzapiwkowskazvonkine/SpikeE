function varargout = Visualize_Responsive_Pixels(varargin)
% VISUALIZE_RESPONSIVE_PIXELS M-file for Visualize_Responsive_Pixels.fig
%      VISUALIZE_RESPONSIVE_PIXELS, by itself, creates a new VISUALIZE_RESPONSIVE_PIXELS or raises the existing
%      singleton*.
%
%      H = VISUALIZE_RESPONSIVE_PIXELS returns the handle to a new VISUALIZE_RESPONSIVE_PIXELS or the handle to
%      the existing singleton*.
%
%      VISUALIZE_RESPONSIVE_PIXELS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISUALIZE_RESPONSIVE_PIXELS.M with the given input arguments.
%
%      VISUALIZE_RESPONSIVE_PIXELS('Property','Value',...) creates a new VISUALIZE_RESPONSIVE_PIXELS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Visualize_Responsive_Pixels_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Visualize_Responsive_Pixels_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Visualize_Responsive_Pixels

% Last Modified by GUIDE v2.5 30-Jan-2013 17:06:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Visualize_Responsive_Pixels_OpeningFcn, ...
                   'gui_OutputFcn',  @Visualize_Responsive_Pixels_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Visualize_Responsive_Pixels is made visible.
function Visualize_Responsive_Pixels_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Visualize_Responsive_Pixels (see VARARGIN)

% Choose default command line output for Visualize_Responsive_Pixels
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Visualize_Responsive_Pixels wait for user response (see UIRESUME)
...
function varargout = Visualize_Responsive_Pixels_OutputFcn(hObject, eventdata, handles) 
