function varargout = Plot_With_Chosen_Params_Fixed_and_Flagged_Removed(varargin)
% PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED M-file for Plot_With_Chosen_Params_Fixed_and_Flagged_Removed.fig
%      PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED, by itself, creates a new PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED or raises the existing
%      singleton*.
%
%      H = PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED returns the handle to a new PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED or the handle to
%      the existing singleton*.
%
%      PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED.M with the given input arguments.
%
%      PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED('Property','Value',...) creates a new PLOT_WITH_CHOSEN_PARAMS_FIXED_AND_FLAGGED_REMOVED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Plot_With_Chosen_Params_Fixed_and_Flagged_Removed

% Last Modified by GUIDE v2.5 13-Mar-2013 14:22:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OpeningFcn, ...
                   'gui_OutputFcn',  @Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Plot_With_Chosen_Params_Fixed_and_Flagged_Removed is made visible.
function Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Plot_With_Chosen_Params_Fixed_and_Flagged_Removed (see VARARGIN)

% Choose default command line output for Plot_With_Chosen_Params_Fixed_and_Flagged_Removed
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Plot_With_Chosen_Params_Fixed_and_Flagged_Removed wait for user response (see UIRESUME)
...
function varargout = Plot_With_Chosen_Params_Fixed_and_Flagged_Removed_OutputFcn(hObject, eventdata, handles) 
...
for i=1:tot
    ...
    if param1>=param1start && param1<=param1stop && param2>=param2start && param2<=param2stop && flag==0    
       inds(end+1)=i;    
    end
