function varargout = Load_Ephys_DataWave_AllEps(varargin)
% LOAD_EPHYS_DATAWAVE_ALLEPS MATLAB code for Load_Ephys_DataWave_AllEps.fig
%      LOAD_EPHYS_DATAWAVE_ALLEPS, by itself, creates a new LOAD_EPHYS_DATAWAVE_ALLEPS or raises the existing
%      singleton*.
%
%      H = LOAD_EPHYS_DATAWAVE_ALLEPS returns the handle to a new LOAD_EPHYS_DATAWAVE_ALLEPS or the handle to
%      the existing singleton*.
%
%      LOAD_EPHYS_DATAWAVE_ALLEPS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LOAD_EPHYS_DATAWAVE_ALLEPS.M with the given input arguments.
%
%      LOAD_EPHYS_DATAWAVE_ALLEPS('Property','Value',...) creates a new LOAD_EPHYS_DATAWAVE_ALLEPS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Load_Ephys_DataWave_AllEps_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Load_Ephys_DataWave_AllEps_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Load_Ephys_DataWave_AllEps

% Last Modified by GUIDE v2.5 29-Nov-2012 18:09:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Load_Ephys_DataWave_AllEps_OpeningFcn, ...
    'gui_OutputFcn',  @Load_Ephys_DataWave_AllEps_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Load_Ephys_DataWave_AllEps is made visible.
function Load_Ephys_DataWave_AllEps_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Load_Ephys_DataWave_AllEps (see VARARGIN)

% Choose default command line output for Load_Ephys_DataWave_AllEps
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Load_Ephys_DataWave_AllEps wait for user response (see UIRESUME)
...
if (length(varargin)>1)
    ...
    set(handles.TotEpsShow,'String',Settings.TotEpsShowString);
end
...
Settings.TotEpsShowString=get(handles.TotEpsShow,'String');


% --- Outputs from this function are returned to the command line.
function varargout = Load_Ephys_DataWave_AllEps_OutputFcn(hObject, eventdata, handles)
...
set(handles.TotEpsShow,'String',num2str(n-1));
