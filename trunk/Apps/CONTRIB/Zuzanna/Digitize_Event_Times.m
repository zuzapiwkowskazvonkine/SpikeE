...
% Last Modified by GUIDE v2.5 22-Oct-2012 19:10:32
...
binned_events=Digitize(SpikeTraceData(k).XVector,binsize,firstbin,handles);
...
% if bins_with_event(1)<0   % for psth analysis?
%     
