function varargout = Plot_Significant_With_Chosen_Params_Fixed(varargin)
% PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED M-file for Plot_Significant_With_Chosen_Params_Fixed.fig
%      PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED, by itself, creates a new PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED or raises the existing
%      singleton*.
%
%      H = PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED returns the handle to a new PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED or the handle to
%      the existing singleton*.
%
%      PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED.M with the given input arguments.
%
%      PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED('Property','Value',...) creates a new PLOT_SIGNIFICANT_WITH_CHOSEN_PARAMS_FIXED or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Plot_Significant_With_Chosen_Params_Fixed_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Plot_Significant_With_Chosen_Params_Fixed_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Plot_Significant_With_Chosen_Params_Fixed

% Last Modified by GUIDE v2.5 17-Feb-2013 14:17:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Plot_Significant_With_Chosen_Params_Fixed_OpeningFcn, ...
                   'gui_OutputFcn',  @Plot_Significant_With_Chosen_Params_Fixed_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Plot_Significant_With_Chosen_Params_Fixed is made visible.
function Plot_Significant_With_Chosen_Params_Fixed_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Plot_Significant_With_Chosen_Params_Fixed (see VARARGIN)

% Choose default command line output for Plot_Significant_With_Chosen_Params_Fixed
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Plot_Significant_With_Chosen_Params_Fixed wait for user response (see UIRESUME)
...
function varargout = Plot_Significant_With_Chosen_Params_Fixed_OutputFcn(hObject, eventdata, handles) 
...
for i=1:tot
    ...
    if param1>=param1start && param1<=param1stop && param2>=param2start && param2<=param2stop && signif>0    
       inds(end+1)=i;    
    end
