function varargout = Visualize_Resps_SignifUpDown_SpontInfo_SDur(varargin)
% VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR M-file for Visualize_Resps_SignifUpDown_SpontInfo_SDur.fig
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR, by itself, creates a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR or raises the existing
%      singleton*.
%
%      H = VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR returns the handle to a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR or the handle to
%      the existing singleton*.
%
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR.M with the given input arguments.
%
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR('Property','Value',...) creates a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO_SDUR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Visualize_Resps_SignifUpDown_SpontInfo_SDur_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Visualize_Resps_SignifUpDown_SpontInfo_SDur_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Visualize_Resps_SignifUpDown_SpontInfo_SDur

% Last Modified by GUIDE v2.5 18-Mar-2013 15:32:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Visualize_Resps_SignifUpDown_SpontInfo_SDur_OpeningFcn, ...
                   'gui_OutputFcn',  @Visualize_Resps_SignifUpDown_SpontInfo_SDur_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Visualize_Resps_SignifUpDown_SpontInfo_SDur is made visible.
function Visualize_Resps_SignifUpDown_SpontInfo_SDur_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Visualize_Resps_SignifUpDown_SpontInfo_SDur (see VARARGIN)

% Choose default command line output for Visualize_Resps_SignifUpDown_SpontInfo_SDur
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Visualize_Resps_SignifUpDown_SpontInfo_SDur wait for user response (see UIRESUME)
...
if (length(varargin)>1)
    ...
    set(handles.SpontInfoTrace,'String',Settings.SpontInfoTraceString);
    set(handles.SpontInfoTrace,'Value',Settings.SpontInfoTraceValue);
    
    set(handles.TraceStimDur,'String',Settings.TraceStimDurString);
    set(handles.TraceStimDur,'Value',Settings.TraceStimDurValue);
...
if ~isempty(SpikeTraceData)
    ...
    set(handles.SpontInfoTrace,'String',TextTrace);
    set(handles.TraceStimDur,'String',TextTrace);
end
...
function varargout = Visualize_Resps_SignifUpDown_SpontInfo_SDur_OutputFcn(hObject, eventdata, handles) 
...
Settings.SpontInfoTraceString=get(handles.SpontInfoTrace,'String');
Settings.SpontInfoTraceValue=get(handles.SpontInfoTrace,'Value');
Settings.TraceStimDurString=get(handles.TraceStimDur,'String');
Settings.TraceStimDurValue=get(handles.TraceStimDur,'Value');
...
listtosave=sort([BeginTrace nbrespstrace xsizetrace ysizetrace intstrace intstabletrace nbtracestrace]);
...
spontinfotrace=get(handles.SpontInfoTrace,'Value');
...
for k=1:length(inds)
    ...
    if SpikeTraceData(spontinfotrace).Trace(inds(k)-psthtrace1+1)==1
        colorpsth='m';
    end
...
stimdurtrace=get(handles.TraceStimDur,'Value');
...
stimdur=SpikeTraceData(stimdurtrace).Trace(filenb);
...
title(['Xsize:' num2str(xsize) ', Ysize:' num2str(ysize) ', Int:' num2str(int) '/ ' num2str(intW) ' uW, Stim Dur:' num2str(stimdur) 's']);
...
% --- Executes on selection change in SpontInfoTrace.
function SpontInfoTrace_Callback(hObject, eventdata, handles)
% hObject    handle to SpontInfoTrace (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns SpontInfoTrace contents as cell array
%        contents{get(hObject,'Value')} returns selected item from SpontInfoTrace


% --- Executes during object creation, after setting all properties.
function SpontInfoTrace_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SpontInfoTrace (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in TraceStimDur.
function TraceStimDur_Callback(hObject, eventdata, handles)
% hObject    handle to TraceStimDur (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns TraceStimDur contents as cell array
%        contents{get(hObject,'Value')} returns selected item from TraceStimDur


% --- Executes during object creation, after setting all properties.
function TraceStimDur_CreateFcn(hObject, eventdata, handles)
% hObject    handle to TraceStimDur (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
