...
% Last Modified by GUIDE v2.5 05-Nov-2012 13:15:25
...
for k=TracesToApply
    ...
    times=Thresh_Cross(SpikeTraceData(k).Trace(1:earlystopint),SpikeTraceData(k).XVector(1:earlystopint),thresh,lowhigh,handles);
