...
%     set(handles.TraceSelector,'Value',Settings.TraceSelectorValue);
    set(handles.GroupTraces,'Value',Settings.GroupTracesValue);
...
Settings.GroupTracesValue=get(handles.GroupTraces,'Value');
...
for k=TracesToApply
    ...
    SpikeTraceData(BeginTrace).XVector(newend+1:newend+addend)=firsttimept+SpikeTraceData(k).XVector(1:addend)+deltaX; 
