function varargout = Get_XY_ObjectiveLocations_NewOrientation(varargin)
% GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION M-file for Get_XY_ObjectiveLocations_NewOrientation.fig
%      GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION, by itself, creates a new GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION or raises the existing
%      singleton*.
%
%      H = GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION returns the handle to a new GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION or the handle to
%      the existing singleton*.
%
%      GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION.M with the given input arguments.
%
%      GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION('Property','Value',...) creates a new GET_XY_OBJECTIVELOCATIONS_NEWORIENTATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Get_XY_ObjectiveLocations_NewOrientation_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Get_XY_ObjectiveLocations_NewOrientation_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Get_XY_ObjectiveLocations_NewOrientation

% Last Modified by GUIDE v2.5 15-Jul-2013 10:49:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Get_XY_ObjectiveLocations_NewOrientation_OpeningFcn, ...
                   'gui_OutputFcn',  @Get_XY_ObjectiveLocations_NewOrientation_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Get_XY_ObjectiveLocations_NewOrientation is made visible.
function Get_XY_ObjectiveLocations_NewOrientation_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Get_XY_ObjectiveLocations_NewOrientation (see VARARGIN)

% Choose default command line output for Get_XY_ObjectiveLocations_NewOrientation
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Get_XY_ObjectiveLocations_NewOrientation wait for user response (see UIRESUME)
...
function varargout = Get_XY_ObjectiveLocations_NewOrientation_OutputFcn(hObject, eventdata, handles) 
...
%%% MODIF
[Xstep_Xaxis, Ystep_Xaxis]=get_XY_steps_Xaxis(Coords_2p); % X and Y steps (in pxls) to move grid from TL to TR corner : TR to BR
[Xstep_Yaxis, Ystep_Yaxis]=get_XY_steps_Yaxis(Coords_2p); % X and Y steps (in pxls) to move grid from TL to BL corner : TR to TL
...
%TR-TL corner -> BR-TR corner
Xstep=coords(7,k)-coords(3,k);
Ystep=coords(8,k)-coords(4,k);
...
%BL-TL corner -> TL-TR corner
% Xstep=coords(5,k)-coords(1,k);
% Ystep=coords(6,k)-coords(2,k);
%->
Xstep=coords(1,k)-coords(3,k);
Ystep=coords(2,k)-coords(4,k);
