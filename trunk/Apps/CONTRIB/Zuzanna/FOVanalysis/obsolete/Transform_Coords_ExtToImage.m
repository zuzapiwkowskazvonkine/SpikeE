function varargout = Transform_Coords_ExtToImage(varargin)
% TRANSFORM_COORDS_EXTTOIMAGE This is the simplest Apps you can make. It is the best start
% to start a new Apps. Just open this Apps in GUIDE, save it to a new
% name and modify it.
%
% Created by Jerome Lecoq in 2012

% Edit the above text to modify the response to help Transform_Coords_ExtToImage

% Last Modified by GUIDE v2.5 09-May-2012 17:00:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Transform_Coords_ExtToImage_OpeningFcn, ...
                   'gui_OutputFcn',  @Transform_Coords_ExtToImage_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Transform_Coords_ExtToImage_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Transform_Coords_ExtToImage (see VARARGIN)

% Choose default command line output for Transform_Coords_ExtToImage
...
function varargout = Transform_Coords_ExtToImage_OutputFcn(hObject, eventdata, handles) 
