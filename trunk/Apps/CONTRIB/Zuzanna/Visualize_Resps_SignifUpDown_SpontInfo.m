function varargout = Visualize_Resps_SignifUpDown_SpontInfo(varargin)
% VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO M-file for Visualize_Resps_SignifUpDown_SpontInfo.fig
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO, by itself, creates a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO or raises the existing
%      singleton*.
%
%      H = VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO returns the handle to a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO or the handle to
%      the existing singleton*.
%
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO.M with the given input arguments.
%
%      VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO('Property','Value',...) creates a new VISUALIZE_RESPS_SIGNIFUPDOWN_SPONTINFO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Visualize_Resps_SignifUpDown_SpontInfo_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Visualize_Resps_SignifUpDown_SpontInfo_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Visualize_Resps_SignifUpDown_SpontInfo

% Last Modified by GUIDE v2.5 13-Mar-2013 14:07:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Visualize_Resps_SignifUpDown_SpontInfo_OpeningFcn, ...
                   'gui_OutputFcn',  @Visualize_Resps_SignifUpDown_SpontInfo_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Visualize_Resps_SignifUpDown_SpontInfo is made visible.
function Visualize_Resps_SignifUpDown_SpontInfo_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Visualize_Resps_SignifUpDown_SpontInfo (see VARARGIN)

% Choose default command line output for Visualize_Resps_SignifUpDown_SpontInfo
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Visualize_Resps_SignifUpDown_SpontInfo wait for user response (see UIRESUME)
...
function varargout = Visualize_Resps_SignifUpDown_SpontInfo_OutputFcn(hObject, eventdata, handles) 
