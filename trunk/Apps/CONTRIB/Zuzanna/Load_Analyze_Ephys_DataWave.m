...
for k=TracesToApply
    ...
    SpikeTraceData(BeginTrace).XVector(newend+1:newend+addend,1)=firsttimept+SpikeTraceData(k).XVector(1:addend,1); %assuming SpikeTraceData(k).TimePoint starts at 1 dx.
