function varargout = Analyze_PSTH_Poisson_diffbins_LoadedBaseline(varargin)
% ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE M-file for Analyze_PSTH_Poisson_diffbins_LoadedBaseline.fig
%      ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE, by itself, creates a new ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE or raises the existing
%      singleton*.
%
%      H = ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE returns the handle to a new ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE or the handle to
%      the existing singleton*.
%
%      ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE.M with the given input arguments.
%
%      ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE('Property','Value',...) creates a new ANALYZE_PSTH_POISSON_DIFFBINS_LOADEDBASELINE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Analyze_PSTH_Poisson_diffbins_LoadedBaseline

% Last Modified by GUIDE v2.5 05-Mar-2013 16:25:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OpeningFcn, ...
                   'gui_OutputFcn',  @Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Analyze_PSTH_Poisson_diffbins_LoadedBaseline is made visible.
function Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Analyze_PSTH_Poisson_diffbins_LoadedBaseline (see VARARGIN)

% Choose default command line output for Analyze_PSTH_Poisson_diffbins_LoadedBaseline
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Analyze_PSTH_Poisson_diffbins_LoadedBaseline wait for user response (see UIRESUME)
...
function varargout = Analyze_PSTH_Poisson_diffbins_LoadedBaseline_OutputFcn(hObject, eventdata, handles) 
