...
forceOutputFlags  = {'show' 'showmovie' 'showmip' 'write' 'writemip' 'writeavi'};
...
TiffLibAccessToFile = Tiff(fileName,'r');
...
try
    ...
    useTIFF = ~verLessThan('matlab','7.13');
                    ...
                    if useImreadInfo
                        if useTIFF
                            ...
                            for r = 1:rps:hImage
                                ...
                                Aout(row_inds,:,count) = tifflib('readEncodedStrip',FileID,stripNum);
                            end
                        else
