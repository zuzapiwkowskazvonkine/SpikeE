function varargout = BackgroundImage_To_Zero(varargin)
% BACKGROUNDIMAGE_TO_ZERO MATLAB code for BackgroundImage_To_Zero.fig
%      BACKGROUNDIMAGE_TO_ZERO, by itself, creates a new BACKGROUNDIMAGE_TO_ZERO or raises the existing
%      singleton*.
%
%      H = BACKGROUNDIMAGE_TO_ZERO returns the handle to a new BACKGROUNDIMAGE_TO_ZERO or the handle to
%      the existing singleton*.
%
%      BACKGROUNDIMAGE_TO_ZERO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BACKGROUNDIMAGE_TO_ZERO.M with the given input arguments.
%
%      BACKGROUNDIMAGE_TO_ZERO('Property','Value',...) creates a new BACKGROUNDIMAGE_TO_ZERO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BackgroundImage_To_Zero_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BackgroundImage_To_Zero_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BackgroundImage_To_Zero

% Last Modified by GUIDE v2.5 17-May-2012 06:44:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BackgroundImage_To_Zero_OpeningFcn, ...
                   'gui_OutputFcn',  @BackgroundImage_To_Zero_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BackgroundImage_To_Zero is made visible.
function BackgroundImage_To_Zero_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BackgroundImage_To_Zero (see VARARGIN)
global SpikeImageData;

% Choose default command line output for BackgroundImage_To_Zero
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes BackgroundImage_To_Zero wait for user response (see UIRESUME)
...
function varargout = BackgroundImage_To_Zero_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    for i=1:NumberImages
        ...
        SpikeImageData(ImageSel(i)).Image(SpikeImageData(ImageSel(i)).Image<LocalThresh)=0;
