function varargout = Remove_Image(varargin)
% REMOVE_IMAGE MATLAB code for Remove_Image.fig
%      REMOVE_IMAGE, by itself, creates a new REMOVE_IMAGE or raises the existing
%      singleton*.
%
%      H = REMOVE_IMAGE returns the handle to a new REMOVE_IMAGE or the handle to
%      the existing singleton*.
%
%      REMOVE_IMAGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in REMOVE_IMAGE.M with the given input arguments.
%
%      REMOVE_IMAGE('Property','Value',...) creates a new REMOVE_IMAGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Remove_Image_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Remove_Image_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Remove_Image

% Last Modified by GUIDE v2.5 01-Mar-2012 16:54:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Remove_Image_OpeningFcn, ...
                   'gui_OutputFcn',  @Remove_Image_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Remove_Image is made visible.
function Remove_Image_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Remove_Image (see VARARGIN)
global SpikeImageData;

% Choose default command line output for Remove_Image
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Remove_Image wait for user response (see UIRESUME)
...
function varargout = Remove_Image_OutputFcn(hObject, eventdata, handles) 
...
try
    ...
    NumberImages=length(SpikeImageData);
    KeepImages=setdiff(1:NumberImages,ImageSel);
    SpikeImageData=SpikeImageData(KeepImages);
